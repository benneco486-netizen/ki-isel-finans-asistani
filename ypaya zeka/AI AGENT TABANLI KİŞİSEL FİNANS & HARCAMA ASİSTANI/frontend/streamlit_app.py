# -*- coding: utf-8 -*-
"""
AI Kişisel Finans Asistanı Streamlit Arayüzü
Bu dosya, kullanıcıların harcama verilerini girmelerini, analiz sonuçlarını
görüntülemelerini ve interaktif grafiklerle tasarruf durumlarını incelemelerini sağlayan
gelişmiş, modern ve zengin tasarımlı frontend arayüzünü tanımlar.
"""
...
# Root dizinini Python yoluna ekle (böylece 'backend' paketini bulabilir)
